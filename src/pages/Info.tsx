...
const content: Record<InfoType, { index: string; title: string; subtitle: string; items: { heading: string; text: string }[] }> = {
  security: {
    ...
    items: [
      ...
      { heading: 'Account access', text: 'Authentication is not connected yet. The account screens cannot create accounts, sign in, confirm an address, or reset a password. No account confirmation or reset codes are generated here.' },
  ...
  privacy: {
    ...
    items: [
      ...
      { heading: 'Code delivery', text: 'No account confirmation or reset code is generated, shown, or emailed. Google sign-in and email authentication are both unavailable until an authentication provider is connected.' },
