...
export function CommunitySection() {
  return <section className="community-section" id="community" aria-labelledby="community-title"><div className="container">
    <div className="section-head community-head"><div><Eyebrow index="05 /">COMMUNITY & OPEN WORK</Eyebrow><h2 id="community-title">Real experiences.<br /><span>Shared openly.</span></h2></div><p>Genuine feedback should come from real experiences, never made-up success stories. Sharing an experience is always a choice.</p></div>
    <ReviewsPanel />
