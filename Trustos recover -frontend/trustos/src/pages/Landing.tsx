...
export function SiteFooter() {
  return <footer className="site-footer"><div className="container">
    <div className="footer-top"><div><Brand /><p>Guidance, recovery, and verification,<br />designed with control in mind.</p></div>
      <div className="footer-link-groups"><div><span>EXPLORE</span><a href="/#how-it-works">How it works</a><a href="/#community">Community</a><Link to="/signup?next=%2Fapp%2Frecovery">Start recovery</Link><Link to="/login">Log in</Link></div>
    ...
    <section className="hero-section"><div className="container">
      <div className="hero-grid">
        <div className="hero-copy">
          ...
          <div className="hero-caption"><span className="hero-caption-icon"><Check size={15} aria-hidden="true" /></span><span>Guided steps. Explicit choices.</span></div>
        </div>
        <TrustosCore />
      </div>
