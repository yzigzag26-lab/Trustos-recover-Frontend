...
export function PreviewTag({ children = 'LOCAL PREVIEW' }: { children?: React.ReactNode }) {
  return <span className="preview-tag"><span className="preview-tag-dot" />{children}</span>;
}
