  ...
  return <header className="site-header"><div className="site-header-inner container">
    ...
    <nav id="site-main-nav" className={`site-nav ${open ? 'site-nav--open' : ''}`} aria-label="Main navigation">
      ...
      <div className="site-nav-actions">
        ...
        <Link className="btn btn-primary btn-nav" to={recoveryLink} onClick={() => setOpen(false)}>Start recovery <ArrowUpRight size={16} aria-hidden="true" /></Link>
      </div>
    </nav>
...
export function SiteFooter() {
  return <footer className="site-footer"><div className="container">
    <div className="footer-top"><div><Brand /><p>Guidance, recovery, and verification,<br />designed with control in mind.</p></div>
      <div className="footer-link-groups"><div><span>EXPLORE</span><a href="/#how-it-works">How it works</a><Link to="/signup?next=%2Fapp%2Frecovery">Start recovery</Link><Link to="/login">Log in</Link></div>
      <div><span>INFORMATION</span><Link to="/security">Security</Link><Link to="/privacy">Privacy</Link><Link to="/terms">Terms</Link></div></div>
    </div>
    <div className="footer-bottom"><span>© {new Date().getFullYear()} Trustos by LinuxBoss</span><span>RECOVERY • GUIDANCE • VERIFICATION</span><span>Interface preview. No live recovery.</span></div>
  </div></footer>;
}
...
export function LandingPage() {
  ...
  return <div className="marketing-page"><SiteHeader /><main>
    <section className="hero-section"><div className="container">
      <div className="hero-grid">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><Link className="btn btn-primary btn-lg" to={recoveryLink}>Start recovery <ArrowUpRight size={19} aria-hidden="true" /></Link><a className="btn btn-outline btn-lg" href="#how-it-works">See how it works <ArrowRight size={18} aria-hidden="true" /></a></div>
          <div className="hero-caption"><span className="hero-caption-icon"><Check size={15} aria-hidden="true" /></span><span>Guided steps. Explicit choices. No live recovery in this preview.</span></div>
        </div>
        <TrustosCore />
      </div>
    ...
    <section className="privacy-section section-space" id="security"><div className="container"><div className="privacy-panel">
      <div className="privacy-content"><Eyebrow index="03 /">PRIVACY & SECURITY</Eyebrow><h2>Keep sensitive work<br /><span>close to home.</span></h2><p>Sensitive recovery computation is designed to stay on your device where the architecture permits. When a service is needed, that boundary should be visible—not hidden behind a promise.</p>
      ...
      <div className="privacy-diagram" aria-label="Conceptual data boundary: your device handles sensitive steps, only necessary information reaches services">
        ...
        <div className="diagram-caption"><span className="diagram-caption-dot" />The exact architecture depends on the recovery method and future integrations.</div>
      </div>
    </div></div></section>
    ...
    <section className="verification-section section-space" id="verification"><div className="container"><div className="verification-grid">
      <div className="verification-visual"><div className="verification-visual-top"><span>REVIEW FRAMEWORK</span><span>ILLUSTRATIVE / NOT A RESULT</span></div>
        <div className="review-card"><div className="review-card-kicker"><div className="review-card-glyph"><ScanSearch size={23} strokeWidth={1.4} aria-hidden="true" /></div><span>REVIEW BEFORE YOU RELY ON IT</span></div>
          ...
          <div className="review-card-bottom"><span>NO LIVE DATA DISPLAYED</span><span>TRANSPARENCY BY DESIGN <ArrowUpRight size={13} aria-hidden="true" /></span></div>
        </div>
      ...
      <div className="verification-content"><Eyebrow index="04 /">VERIFICATION</Eyebrow><h2>Don't just trust<br />the outcome.<br /><span>Understand it.</span></h2><p>Real confidence comes from being able to examine the process and check what matters using sources you trust. Trustos is designed to make that review part of the journey—not an afterthought.</p><div className="verification-principle"><ShieldAlert size={20} strokeWidth={1.5} aria-hidden="true" /><span>This preview does not display real blockchain checks, transaction data, or recovery results.</span></div><ArrowLink to="/security">Read about verification</ArrowLink></div>
    </div></div></section>

    <section className="landing-cta-section"><div className="container"><div className="landing-cta"><div className="landing-cta-pattern" aria-hidden="true"><div /><div /><div /></div><div><Eyebrow index="05 /">YOUR NEXT STEP</Eyebrow><h2>Start with the right<br />question.</h2><p>Tell us what you're trying to understand. We'll help you move through it deliberately.</p></div><Link to={recoveryLink} className="btn btn-primary btn-lg">Start recovery <ArrowUpRight size={19} aria-hidden="true" /></Link></div></div></section>
  </main><SiteFooter /></div>;
}
